def prediction(stock, n_days):
    ...
    fig.add_trace(
        go.Scatter(
            ...
            name='data'))
    fig.update_layout(
        title="Predicted Close Price of next " + str(n_days - 1) + " days with help of SVR",
        xaxis_title="Date",
...
def prediction1(stock, n_days):
    ...
    fig.add_trace(
        go.Scatter(
            ...
            name='data'))
    fig.update_layout(
        title="Predicted Close Price of next " + str(n_days - 1) + " days with help of LR",
        xaxis_title="Date",
        yaxis_title="Closed Price",
        # legend_title="Legend Title",
    )
